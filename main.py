...
ax.annotate(f'LeBron James ({lbj_1["mp"][0]} min played)', xy=(lbj_1.index[0], lbj_1['pts'][0]), xytext=(lbj_1.index[0], lbj_1['pts'][0] - 75), color = 'gold')
ax.annotate(f'Michael Jordan ({mj["mp"][0]} min played)', xy=(mj.index[0], mj['pts'][0]), xytext=(mj.index[0] + 0.1, mj['pts'][0] - 75), color = 'red')
ax.annotate(f'Kareem Abdul-Jabbar ({kareem["mp"][0]} min played)', xy=(kareem.index[0], kareem['pts'][0]), xytext=(kareem.index[0], kareem['pts'][0] + 125), color = 'green')
ax.annotate(f'Kobe Bryant ({kobe["mp"][0]} min played)', xy=(kobe.index[0], kobe['pts'][0]), xytext=(kobe.index[0], kobe['pts'][0] - 100), color = 'blue')
ax.annotate(f'Stephen Curry ({curry["mp"][0]} min played)', xy=(curry.index[0], curry['pts'][0]), xytext=(curry.index[0], curry['pts'][0] - 100), color = 'purple')
