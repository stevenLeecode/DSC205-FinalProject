...
player_goats = (['LeBron James', 2021], ['Michael Jordan', 1998], ['Kareem Abdul-Jabbar', 1987], ['Kobe Bryant', 2014], ['Stephen Curry', 2021])

for name, year in player_goats:
    last_3_seasons(name, year)
