...
ax.annotate(f'{lbj_avg} pps', xy=(player_avg_df['player'][0], player_avg_df['avg_pts'][0]), xytext=(-0.185, lbj_avg - 200), color = 'gold')
ax.annotate(f'{mj_avg} pps', xy=(player_avg_df['player'][1], player_avg_df['avg_pts'][1]), xytext=(1 - 0.185, mj_avg - 235), color = 'red')
ax.annotate(f'{kareem_avg} pps', xy=(player_avg_df['player'][2], player_avg_df['avg_pts'][2]), xytext=(2 - 0.185, kareem_avg - 170), color = 'green')
ax.annotate(f'{kobe_avg} pps', xy=(player_avg_df['player'][3], player_avg_df['avg_pts'][3]), xytext=(3 - 0.185, kobe_avg - 200), color = 'blue')
ax.annotate(f'{curry_avg} pps', xy=(player_avg_df['player'][4], player_avg_df['avg_pts'][4]), xytext=(4 - 0.185, curry_avg - 200), color = 'purple')
