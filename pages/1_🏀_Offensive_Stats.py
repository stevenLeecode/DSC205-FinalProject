...
ax.annotate(f'{mj_avg} pps', xy=(player_avg_df['player'][1], player_avg_df['avg_pts'][1]), xytext=(1 - 0.185, mj_avg - 200), color = 'red')
ax.annotate(f'{kareem_avg} pps', xy=(player_avg_df['player'][2], player_avg_df['avg_pts'][2]), xytext=(2 - 0.185, kareem_avg - 200), color = 'green')
